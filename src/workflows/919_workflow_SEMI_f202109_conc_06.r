...
TS_strategy_base9 <- function( pinputexps )
{
  ...
  param_local$final_train$training <- c(
    ...
    202005, 202002, 202001, 202004,202003, #Excluyo pandemia marzo y abril 2020
    201912, 201911,
...
KA_evaluate_kaggle_semillerio <- function( pinputexps )
{
  ...
  param_local$envios_desde <-  2200L #1600
  param_local$envios_hasta <-  4000L #2200
  param_local$envios_salto <-   300L #100
...
#CA MICE
#DR Dolar blue
#HT learning_rate agrego limite superior de 1.8
